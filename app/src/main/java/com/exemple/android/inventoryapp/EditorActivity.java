...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
     ...
     * {@link ProductEntry#GENDER_UNKNOWN}, {@link ProductEntry#GENDER_MALE}, or
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // check if we are creating a new product or editing
        Intent intent = getIntent();
        mCurrentProductUri = intent.getData();

        //Uri currentProductUri = intent.getData();

/*        //if the intent does not contain a product content uri then we are creating
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = ProductEntry.GENDER_MALE; // Male
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = ProductEntry.GENDER_FEMALE; // Female
                    } else {
                        mGender = ProductEntry.GENDER_UNKNOWN; // Unknown
                    }
                }
            }
